...
\begin{figure}[h!]
    ...
    \caption{Perbandingan visibilitas alamat IP pada antarmuka penangkapan data. Bagian atas menunjukkan kondisi Non-VPN (antarmuka fisik dengan \textit{Source IP} 131.202.240.87), sedangkan bagian bawah menunjukkan kondisi VPN yang direkam di dalam \texttt{tun0} (pergeseran \textit{Source IP} menjadi 10.8.8.178).}
...
Alamat IP Sumber & Alamat IP Publik asli komputer \textit{host} (Blok Universitas: \texttt{131.202.240.87}) & Alamat IP Privat Virtual internal terowongan OpenVPN (\texttt{10.8.8.178}) \\ \hline
Alamat IP Tujuan & Alamat IP Publik Server Aplikasi asli (Contoh Server AIM: \texttt{205.188.12.91}) & Alamat IP Publik Server Aplikasi asli (Contoh Server AIM: \texttt{205.188.12.91}) \\ \hline
