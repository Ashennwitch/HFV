...
Sebagaimana diilustrasikan pada Gambar \ref{fig:distribusi_aplikasi}, pendekatan selektif ini pada akhirnya memfilter dan menyisakan aplikasi dominan seperti \texttt{Skype}, \texttt{BitTorrent}, \texttt{Hangout}, \texttt{Facebook}, dan \texttt{YouTube} (serta beberapa aplikasi lain yang melewati \textit{threshold}) sebagai target klasifikasi \textit{fine-grained}. Keputusan pemfilteran ini krusial untuk memastikan bahwa evaluasi metrik kinerja kerangka kerja HFV tetap valid secara statistik dan tidak terdistorsi oleh anomali keterwakilan data.
